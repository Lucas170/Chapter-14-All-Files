...
double sma10_1, sma10_2, sma40_1, sma40_2, rsiFromMyInd_1;
...
int start() {
   ...
   rsiFromMyInd_1 = iCustom(NULL, 0, "MyPracticeIndicator_RSI_Stoc_Complete", 20, 5, 3, 3, 0, 1); // RSI(20) 1 period ago
   // Docs for iCustom: https://docs.mql4.com/indicators/icustom
   ...
   */
   ...
   if(atr_current > atr_past)  {
      ...
      if(rsiFromMyInd_1 > 70) if(sma40_2 > sma10_2 && sma10_1 >= sma40_1) Order = SIGNAL_BUY; // Rule to ENTER a Long trade
   
      if(rsiFromMyInd_1 < 30) if(sma10_2 > sma40_2 && sma40_1 >= sma10_1) Order = SIGNAL_SELL; // Rule to ENTER a Short trade
